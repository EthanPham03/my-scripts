...
# Script Name:                      401 ops challenge 28
# Author:                           Ethan Pham
# Date of latest revision:          Jun 5, 2024
# Purpose:                          Use FileHandler and StreamHandler to write a local file and output to terminal
...
log_file_handler = RotatingFileHandler('class26.log', maxBytes=5*1024*1024, backupCount=5, encoding='utf-8')
