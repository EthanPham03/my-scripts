...
# Script Name:                      401 ops challenge 26
# Author:                           Ethan Pham
# Date of latest revision:          Jun 3, 2024
# Purpose:                          Add logging to an old script
...
logging.basicConfig(filename='class26.log', encoding='utf-8', level=logging.DEBUG)
